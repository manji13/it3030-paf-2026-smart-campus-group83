...
export default function UserManagement() {
    ...
    const fetchUsers = async () => {
        try {
            ...
            showToastMessage('Error fetching users', 'error');
        } finally {
            setLoading(false);
        }
    };
    ...
    return (
        <div className={`min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 py-8 px-4 sm:px-6 lg:px-8 transition-all duration-500 ${pageLoaded ? 'opacity-100' : 'opacity-0'}`}>
