...
import { exportToCSV, exportToPDF, getTimestampedFilename } from '../../utils/exportUtils';
...
export default function AdminFacilitiesPage() {
    ...
    const handleExportCSV = () => {
        exportToCSV(filtered, getTimestampedFilename('resources', 'csv'));
    };

    const handleExportPDF = () => {
        exportToPDF(filtered, getTimestampedFilename('resources', 'pdf'));
    };
                    ...
                    <div className="flex items-center gap-3 flex-wrap">
                        ...
                        <div className="flex gap-2">
                            <button
                                ...
                                title="Export resources as CSV"
                                className="flex items-center gap-2 px-4 py-2.5 rounded-xl bg-gray-700 hover:bg-gray-600 disabled:opacity-50 disabled:cursor-not-allowed text-white font-semibold transition-all shadow-lg hover:-translate-y-0.5"
                            >
                                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 10v6m4-3H8m12-9H4a2 2 0 00-2 2v14a2 2 0 002 2h16a2 2 0 002-2V4a2 2 0 00-2-2z" />
                                </svg>
                                CSV
                            </button>
                            <button
